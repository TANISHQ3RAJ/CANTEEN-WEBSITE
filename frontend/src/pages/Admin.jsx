      ...
      <table className="w-full text-left border-collapse">
        ...
        <tbody>
          {orders.length === 0 ? (
            ...
            orders.map((order) => (
              <tr key={order._id || order.orderId} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                <td className="p-4 font-mono font-medium text-gray-800">{order.orderId}</td>
